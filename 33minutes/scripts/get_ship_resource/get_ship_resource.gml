...
function get_ship_resource(shipID,resource){
...
switch(resource){
	case "hp": return shipHP;
	break;
	case "civilians": return shipCivs;
	break;
	case "marines": return shipMars;
	break;
	case "scientists": return shipSci;
	break;
	case "engineers": return shipEng;
	break;
	case "food": return shipFood;
	break;
	case "parts": return shipParts;
	break;
	case "water": return shipWater;
	break;
	case "medicine": return shipMedicine;
	break;
}
}